...
T = TypeVar("T", bound="SubmitExtractionJobBody")


@_attrs_define
class SubmitExtractionJobBody:
    """
    Attributes:
        file (File):
        format_ (ResultFormat | Unset): Extraction output format. Default: `markdown`.
        languages (str | Unset): Comma-separated OCR language hints.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        submit_extraction_job_body = cls(
            file=file,
            format_=format_,
            languages=languages,
        )

        submit_extraction_job_body.additional_properties = d
        return submit_extraction_job_body
